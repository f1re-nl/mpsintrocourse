...
<model ref="r:be996a2f-07f1-40ae-85cd-c6d769615580(statemachine.test.editor)">
    ...
    <node concept="3EZMnI" id="6u4eORbDKGp" role="2wV5jI">
      ...
      <node concept="3EZMnI" id="6u4eORbDKHv" role="3EZMnx">
        ...
        <node concept="3F2HdR" id="6u4eORbDKHS" role="3EZMnx">
          ...
          <node concept="4$FPG" id="6tLXQUxxtTY" role="4_6I_">
            <node concept="3clFbS" id="6tLXQUxxtTZ" role="2VODD2">
              <node concept="3clFbF" id="6tLXQUxxtVX" role="3cqZAp">
                <node concept="2ShNRf" id="6tLXQUxxtVV" role="3clFbG">
                  <node concept="3zrR0B" id="6tLXQUxxuPw" role="2ShVmc">
                    <node concept="3Tqbb2" id="6tLXQUxxuPy" role="3zrR0E">
                      <ref role="ehGHo" to="adlf:6tLXQUxxtTh" resolve="EmptyTestCaseContent" />
                    </node>
                  </node>
                </node>
              </node>
  ...
  <node concept="22mcaB" id="6tLXQUxyfW1">
    ...
    <node concept="22hDWj" id="6tLXQUxyfW2" role="22hAXT" />
  </node>
  <node concept="24kQdi" id="VFjlN7JVPe">
    <ref role="1XX52x" to="adlf:6u4eORbDoP$" resolve="AssertState" />
    <node concept="2aJ2om" id="VFjlN7JW1l" role="CpUAK">
      <ref role="2$4xQ3" to="n0jx:L1AWMdYU9P" resolve="fancy" />
    </node>
    <node concept="2r0Tta" id="VFjlN7JWc$" role="2wV5jI">
      <node concept="2reCLk" id="VFjlN7JWcC" role="2r0Tv6">
        ...
        <node concept="2reCLy" id="VFjlN7JWcQ" role="2reCL6">
          ...
          <node concept="1g0IQG" id="3gChSzHFmVe" role="1geGt4">
            <node concept="3tD6jV" id="3gChSzHFmVm" role="3F10Kt">
              <ref role="3tD7wE" to="reoo:5PDTdguqQmB" resolve="shade-color" />
              <node concept="3sjG9q" id="3gChSzHFmVn" role="3tD6jU">
                <node concept="3clFbS" id="3gChSzHFmVo" role="2VODD2">
                  <node concept="3clFbF" id="3gChSzHFmZ8" role="3cqZAp">
                    <node concept="2OqwBi" id="3gChSzHFndh" role="3clFbG">
                      <node concept="pncrf" id="3gChSzHFmZ7" role="2Oq$k0" />
                      <node concept="2qgKlT" id="3gChSzHFnsR" role="2OqNvi">
                        <ref role="37wK5l" to="inh3:4ByeTwKsaAE" resolve="execColor" />
                      </node>
                    </node>
                  </node>
